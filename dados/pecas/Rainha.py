...
from dados.Peca import Peca

class Rainha(Peca):
	def __init__(self, pos, tabuleiro):
		super().__init__(pos, tabuleiro)

		img_path = 'dados/imgs/rainha.png'
		self.img = pygame.image.load(img_path)
		self.img = pygame.transform.scale(self.img, (tabuleiro.largura_espaco - 20, tabuleiro.altura_espaco - 20))
